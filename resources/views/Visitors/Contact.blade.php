...
@section('main-section')
    ...
    <div class="container mx-auto my-20">
        <div class="w-full flex flex-col md:flex-row items-start">
            <div class="w-80 mx-auto md:w-1/2 md:mx-0 bg-white rounded-xl p-2 md:p-5 space-y-5 md:mr-5">
            ...
            <div class="w-1/2">
                <h2 class="text-2xl md:text-[45px] font-light mb-10">Contact <span class="font-medium">Us</span></h2>
            </div>
        </div>
    </div>
@endsection
